...
import { CurrencyExchangeComponent } from './exchange/currency-exchange.component';
...
export class MainCurrencyComponent extends UnsubscribeOnDestroyAdapter implements OnInit {
  pageTitle = 'MENUITEMS.MASTER.LIST.CURRENCY'
  breadcrumsMiddleList = [
    { text: 'MENUITEMS.MASTER.TEXT', route: '/admin/master/currency' }
  ]
  ...
  langText = {
    ...
    CURRENCY: 'MENUITEMS.MASTER.LIST.CURRENCY',
  }

  tabConfig = [
    {
      label: this.translatedLangText.CURRENCY,
      component: 'app-currency-exchange',
      modulePackage: ['starter', 'growth', 'customized'],
      expectedFunctions: ['MASTER_CURRENCY_EDIT', 'MASTER_CURRENCY_ADD', 'MASTER_CURRENCY_DELETE', 'MASTER_CURRENCY_VIEW'],
    }
  ...
  @ViewChild('currencyExchange') currencyExchange!: CurrencyExchangeComponent;
  
  onTabSelected(event: MatTabChangeEvent): void {
    console.log(`Selected Index: ${event.index}, Tab Label: ${event.tab.textLabel}`);
    switch (event.index) {
      case 0:
        this.currencyExchange?.onTabFocused(); break;
    }
  }
}