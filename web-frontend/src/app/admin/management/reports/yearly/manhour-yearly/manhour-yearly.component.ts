...
@Component({
  selector: 'app-manhour-yearly',
  standalone: true,
  templateUrl: './manhour-yearly.component.html',
  styleUrl: './manhour-yearly.component.scss',
  imports: [
    MatTooltipModule,
    MatButtonModule,
    MatIconModule,
...
export class ManHourYearlyAdminReportComponent extends UnsubscribeOnDestroyAdapter implements OnInit {
  displayedColumns = [
    'select',
    'tank_no',
    'customer',
