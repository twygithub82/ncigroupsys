...
@Component({
  ...
  standalone: true,
  templateUrl: './revenue-yearly.component.html',
  styleUrl: './revenue-yearly.component.scss',
  imports: [
    MatTooltipModule,
    MatButtonModule,
    MatIconModule,
...
export class RevenueYearlyAdminReportComponent extends UnsubscribeOnDestroyAdapter implements OnInit {
  displayedColumns = [
    'select',
    'tank_no',
    'customer',
