...
@Component({
  ...
  standalone: true,
  templateUrl: './inventory-monthly.component.html',
  styleUrl: './inventory-monthly.component.scss',
  imports: [
    MatTooltipModule,
    MatButtonModule,
    MatIconModule,
...
export class InventoryMonthlyAdminReportComponent extends UnsubscribeOnDestroyAdapter implements OnInit {
  displayedColumns = [
    'select',
    'tank_no',
    'customer',
