...
@Component({
  selector: 'app-manhour-monthly',
  standalone: true,
  templateUrl: './manhour-monthly.component.html',
  styleUrl: './manhour-monthly.component.scss',
  imports: [
    MatTooltipModule,
    MatButtonModule,
    MatIconModule,
...
export class ManHourMonthlyAdminReportComponent extends UnsubscribeOnDestroyAdapter implements OnInit {
  displayedColumns = [
    'select',
    'tank_no', 
    'customer',
