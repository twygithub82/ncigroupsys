...
@Component({
  selector: 'app-main-management-performance',
  standalone: true,
  templateUrl: './main-management-performance.component.html',
  styleUrl: './main-management-performance.component.scss',
  imports: [
    BreadcrumbComponent,
    MatTooltipModule,
    MatButtonModule,
...
export class MainManagementPerformanceComponent extends UnsubscribeOnDestroyAdapter implements OnInit {
  ...
  pageTitle = 'MENUITEMS.MANAGEMENT.LIST.PERFORMANCE-REPORTS'
  breadcrumsMiddleList = [
    { text: 'MENUITEMS.MANAGEMENT.TEXT', route: '/admin/management/reports/performance' }
  ]
