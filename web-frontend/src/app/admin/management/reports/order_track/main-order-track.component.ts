...
@Component({
  ...
  standalone: true,
  templateUrl: './main-order-track.component.html',
  styleUrl: './main-order-track.component.scss',
  imports: [
    BreadcrumbComponent,
    MatTooltipModule,
    MatButtonModule,
    ...
    MatCardModule,
    MatTabsModule,
   OrderTrackReportComponent

  ]
})
export class MainManagementReportOrderTrackComponent extends UnsubscribeOnDestroyAdapter implements OnInit {
  ...
  pageTitle = 'MENUITEMS.MANAGEMENT.LIST.ORDER-TRACK-REPORTS'
  breadcrumsMiddleList = [
    { text: 'MENUITEMS.MANAGEMENT.TEXT', route: '/admin/reports/order-track' },
  ]
