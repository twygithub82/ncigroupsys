...
import { JobOrderDS, JobOrderGO, JobProcessRequest, SteamJobOrderRequest } from 'app/data-sources/job-order';
...
export class SteamQCViewComponent extends UnsubscribeOnDestroyAdapter implements OnInit {
  displayedColumns = [
    'seq',
    // 'group_name_cv',
    'desc',
