...
export class CleaningProceduresNewComponent implements OnInit {
  ...
  PROCEDURE_DETAILS = 'CLEAN-PROCEDURES.FORMS.PROCEDURE-DETAILS'
  PROCEDURE_NAME = 'CLEAN-PROCEDURES.FORMS.PROCEDURE-NAME'
  PROCEDURE_DESCRIPTION = 'CLEAN-PROCEDURES.FORMS.DESCRIPTION'
  PROCEDURE_CLEAN_CATEGORY = 'CLEAN-PROCEDURES.FORMS.CLEAN-CATEGORY'
  PROCEDURE_CLEAN_GROUP = 'CLEAN-PROCEDURES.FORMS.CLEAN-GROUP'
  PROCEDURE_MIN_COST = 'CLEAN-PROCEDURES.FORMS.MIN-COST'
  PROCEDURE_MAX_COST = 'CLEAN-PROCEDURES.FORMS.MAX-COST'
  PROCEDURE_TOTAL_DURATION = 'CLEAN-PROCEDURES.FORMS.TOTAL-DURATION'
  PROCEDURE_REQUIRED = 'CLEAN-PROCEDURES.FORMS.IS-REQUIRED'
  PROCEDURE_STEPS = 'CLEAN-PROCEDURES.FORMS.PROCEDURE-STEPS'
  PROCEDURE_STEP_NAME = 'CLEAN-PROCEDURES.FORMS.STEP-NAME'
  PROCEDURE_STEP_DURATION = 'CLEAN-PROCEDURES.FORMS.STEP-DURATION'
  PROCEDURE_STEP_DURATION_TOOLTIP = 'CLEAN-PROCEDURES.FORMS.STEP-DURATION-TOOLTIP'
