...
import { PackageBufferCleaningCostPdfComponent } from 'app/document-template/pdf/package/cleaning/buffer-cleaning/package-buffer-cleaning-cost-pdf.component';
...
export class PackageBufferComponent extends UnsubscribeOnDestroyAdapter
  ...
  exportPdfReport(repData: any) {
    ...
    const dialogRef = this.dialog.open(PackageBufferCleaningCostPdfComponent, {
      width: reportPreviewWindowDimension.portrait_width_rate,
      maxWidth: reportPreviewWindowDimension.portrait_maxWidth,
      maxHeight: reportPreviewWindowDimension.report_maxHeight,
