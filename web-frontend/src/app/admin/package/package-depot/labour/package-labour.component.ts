...
import { PackageLabourCostExcelComponent } from 'app/document-template/excel/package/depot/labour-cost/package-labour-cost-excel.component';
import { Package } from 'angular-feather/icons';
import { PackageLabourCostPdfComponent } from 'app/document-template/pdf/package/depot/labour-cost/package-labour-cost-pdf.component';
...
export class PackageLabourComponent extends UnsubscribeOnDestroyAdapter
  ...
  exportExcelReport(repData: any) {
    ...
    const dialogRef = this.dialog.open(PackageLabourCostExcelComponent, {
  ...
  exportPdfReport(repData: any) {
    ...
    const dialogRef = this.dialog.open(PackageLabourCostPdfComponent, {
      width: reportPreviewWindowDimension.portrait_width_rate,
      maxWidth: reportPreviewWindowDimension.portrait_maxWidth,
      maxHeight: reportPreviewWindowDimension.report_maxHeight,
