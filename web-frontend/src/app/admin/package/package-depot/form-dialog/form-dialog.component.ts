...
export class FormDialogComponent extends UnsubscribeOnDestroyAdapter {
  ...
  loadData()
  {
    ...
    if(this.selectedItems.length==1)
    {
      ...
      this.pcForm.patchValue({
        ...
        preinspection_cost_standard:pckDepotItm.preinspection_cost,
  ...
  save() {
    ...
    var lolo_cost = Number(this.pcForm!.value["lolo_cost_cust"]);
    var preinspection_cost = Number(this.pcForm!.value["preinspection_cost_cust"]);
    var free_storage = Number(this.pcForm!.value["free_storage_days"]);
    var storage_cost = Number(this.pcForm!.value["storage_cost_cust"]);
    ...
    var remarks = this.pcForm!.value["remarks"]||"";
      ...
      this.packageDepotDS?.updatePackageDepots(pd_guids,free_storage,lolo_cost,preinspection_cost,storage_cost,remarks,storage_cal_cv).subscribe(result=>{
