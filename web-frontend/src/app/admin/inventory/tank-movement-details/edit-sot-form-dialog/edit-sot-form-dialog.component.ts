...
@Component({
  selector: 'app-edit-sot-form-dialog-form-dialog',
  templateUrl: './edit-sot-form-dialog.component.html',
  styleUrls: ['./edit-sot-form-dialog.component.scss'],
...
export class EditSotFormDialogComponent {
  sot: StoringOrderTankItem;
  ...
  constructor(
    public dialogRef: MatDialogRef<EditSotFormDialogComponent>,
