...
@Component({
  selector: 'app-update-tank-no-dialog',
  templateUrl: './update-tank-no-dialog.component.html',
  styleUrls: ['./update-tank-no-dialog.component.scss'],
...
export class UpdateTankNoDialogComponent {
  ...
  constructor(
    public dialogRef: MatDialogRef<UpdateTankNoDialogComponent>,
