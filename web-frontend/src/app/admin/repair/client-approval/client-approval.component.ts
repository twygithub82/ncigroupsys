...
@Component({
  selector: 'app-repair-client-approval',
  standalone: true,
...
export class RepairApprovalClientComponent extends UnsubscribeOnDestroyAdapter implements OnInit {
  displayedColumns = [
    'tank_no',
    'customer',
    'eir_dt',
  ...
  constructSearchCriteria() {
    ...
    const sotSome: any = { storing_order: { customer_company_guid: { in: this.authService.getClientCompany() } } };
  ...
  performSearch(pageSize: number, pageIndex: number, first?: number, after?: string, last?: number, before?: string, callback?: () => void) {
    ...
    this.subs.sink = this.repairDS.searchRepairForClient(this.lastSearchCriteria, this.lastOrderBy, first, after, last, before)
      .subscribe(data => {
