...
@Component({
  selector: 'app-repair-monthly',
  standalone: true,
  templateUrl: './repair-monthly.component.html',
  styleUrl: './repair-monthly.component.scss',
  imports: [
    MatTooltipModule,
    MatButtonModule,
    MatIconModule,
...
export class RepairMonthlyAdminReportComponent extends UnsubscribeOnDestroyAdapter implements OnInit {
  displayedColumns = [
    'select',
    'tank_no',
    'customer',
