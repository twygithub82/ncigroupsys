...
@Component({
  ...
  standalone: true,
  templateUrl: './residue-yearly.component.html',
  styleUrl: './residue-yearly.component.scss',
  imports: [
    MatTooltipModule,
    MatButtonModule,
    MatIconModule,
...
export class ResidueYearlyAdminReportComponent extends UnsubscribeOnDestroyAdapter implements OnInit {
  displayedColumns = [
    'select',
    'tank_no',
    'customer',
