...
@Component({
  ...
  standalone: true,
  templateUrl: './steam-yearly.component.html',
  styleUrl: './steam-yearly.component.scss',
  imports: [
    MatTooltipModule,
    MatButtonModule,
    MatIconModule,
...
export class SteamYearlyAdminReportComponent extends UnsubscribeOnDestroyAdapter implements OnInit {
  displayedColumns = [
    'select',
    'tank_no',
    'customer',
