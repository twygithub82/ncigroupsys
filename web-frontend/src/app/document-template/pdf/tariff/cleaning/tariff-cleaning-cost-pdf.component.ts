...
export class TariffCleaningCostPdfComponent extends UnsubscribeOnDestroyAdapter implements OnInit {
  ...
  @ViewChild('pdfTable') pdfTable!: ElementRef; // Reference to the HTML content
   ...
   async exportToPDF_r1(fileName: string = 'document.pdf') {
    ...
    const comStyles: any = {
      0: { cellWidth: 12,valign: 'middle', halign: 'center' ,overflow: 'ellipsize'},    // "No."
      1: { cellWidth: 46 ,valign: 'middle', halign: 'left',  overflow: 'ellipsize' },   // "NAME"
      2: { cellWidth: 17, valign: 'middle', halign: 'center',overflow: 'ellipsize' },  // "CARGO_CLASS"
      3: { cellWidth: 19, valign: 'middle', halign: 'center',overflow: 'ellipsize' },  // "CARGO_UN_NO"
      4: { cellWidth: 21, valign: 'middle', halign: 'center',overflow: 'ellipsize' },   // "CARGO_METHOD "
      5: { cellWidth: 19, valign: 'middle', halign: 'center',overflow: 'ellipsize' },   // "CARGO_CATEGORY"
      6: { cellWidth: 19, valign: 'middle', halign: 'center',overflow: 'ellipsize' },   // "CARGO_FLASH_POINT"
      7: { cellWidth: 18, valign: 'middle', halign: 'center',overflow: 'ellipsize' },   // "CARGO_BAN_TYPE"
      8: { cellWidth: 18, valign: 'middle', halign: 'center',overflow: 'ellipsize' },   // "CARGO_COST"
    };
