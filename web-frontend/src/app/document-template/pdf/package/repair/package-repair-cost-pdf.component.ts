...
@Component({
  selector: 'app-package-repair-cost-report-pdf',
  templateUrl: './package-repair-cost-pdf.component.html',
  styleUrls: ['./package-repair-cost-pdf.component.scss'],
  standalone: true,
  imports: [
    FormsModule,
    MatButtonModule,
...
export class PackageRepairCostPdfComponent extends UnsubscribeOnDestroyAdapter implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<PackageRepairCostPdfComponent>,
 ...
 async export(items: TariffCleaningItem[]) {
  ...
  GetReportTitle(): string {
    var title: string = '';
     title = `${this.translatedLangText.PACKAGE_REPAIR}`;
    return `${title}`
  }
