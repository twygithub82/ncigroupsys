...
@Component({
  selector: 'app-package-exclusive-steaming-cost-report-pdf',
  templateUrl: './package-exclusive-steaming-cost-pdf.component.html',
  styleUrls: ['./package-exclusive-steaming-cost-pdf.component.scss'],
  standalone: true,
  imports: [
    FormsModule,
    MatButtonModule,
...
export class PackageExclusiveSteamingCostPdfComponent extends UnsubscribeOnDestroyAdapter implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<PackageExclusiveSteamingCostPdfComponent>,
  ...
  @ViewChild('pdfTable') pdfTable!: ElementRef; // Reference to the HTML content
   ...
   async exportToPDF_r1(fileName: string = 'document.pdf') {
    ...
    const comStyles: any = {
      ...
      2: { valign: 'middle', halign: 'left' },  // "CARGO_CLASS"
      3: { cellWidth: 25, valign: 'middle', halign: 'center' },  // "CARGO_UN_NO"
       4: { cellWidth: 25,valign: 'middle', halign: 'center' },    // "No."
      5: { cellWidth:25,valign: 'middle', halign: 'center'},   // "NAME"
      6: { cellWidth:25,valign: 'middle', halign: 'center' },  // "CARGO_CLASS"
      7: { cellWidth: 25, valign: 'middle', halign: 'center' },  // "CARGO_UN_NO"
 ...
 async export(items: TariffCleaningItem[]) {
  ...
  GetReportTitle(): string {
    var title: string = '';
     title = `${this.translatedLangText.PACKAGE_EXCLUSIVE_STEAMING}`;
    return `${title}`
  }
