...
@Component({
  selector: 'app-package-labour-cost-report-pdf',
  templateUrl: './package-labour-cost-pdf.component.html',
  styleUrls: ['./package-labour-cost-pdf.component.scss'],
  standalone: true,
  imports: [
    FormsModule,
    MatButtonModule,
...
export class PackageLabourCostPdfComponent extends UnsubscribeOnDestroyAdapter implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<PackageLabourCostPdfComponent>,
 ...
 async export(items: TariffCleaningItem[]) {
  ...
  GetReportTitle(): string {
    var title: string = '';
     title = `${this.translatedLangText.PACKAGE_LABOUR_COST}`;
    return `${title}`
  }
