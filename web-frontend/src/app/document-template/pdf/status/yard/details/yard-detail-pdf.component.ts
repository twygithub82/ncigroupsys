...
export class YardDetailInventoryPdfComponent extends UnsubscribeOnDestroyAdapter implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<YardDetailInventoryPdfComponent>,
  ...
  async exportToPDF_r1(fileName: string = 'document.pdf') {
    ...
    for (let n = 0; n < this.report_yard_detail.length; n++) {
     ...
     // lastTableFinalY += 8;
      ...
      // lastTableFinalY += 3;
      PDFUtility.AddTextAtLeftCornerPage(pdf,`${cust.customer}`,pageWidth,leftMargin,rightMargin,lastTableFinalY,PDFUtility.RightSubTitleFontSize());
