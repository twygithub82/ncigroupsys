...
@Component({
  selector: 'app-periodic-test-pdf',
  templateUrl: './periodic-test-pdf.component.html',
  styleUrls: ['./periodic-test-pdf.component.scss'],
  standalone: true,
  imports: [
    FormsModule,
    MatButtonModule,
...
export class PeriodicTestDuePdfComponent extends UnsubscribeOnDestroyAdapter implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<PeriodicTestDuePdfComponent>,
        ...
        autoTable(pdf, {
          ...
          didDrawPage: (data: any) => {
            ...
            if (!pg) {
              pagePositions.push({ page: pageCount, x: pdf.internal.pageSize.width - 20, y: pdf.internal.pageSize.height - 10 });
              if (pageCount > 1) {
                PDFUtility.addReportTitle(pdf, reportTitle, pageWidth, leftMargin, rightMargin, topMargin + 3);
              }
            }
          },
        });
