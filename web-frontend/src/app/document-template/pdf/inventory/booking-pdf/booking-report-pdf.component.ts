...
@Component({
  selector: 'app-booking-report-pdf',
  templateUrl: './booking-report-pdf.component.html',
  styleUrls: ['./booking-report-pdf.component.scss'],
  standalone: true,
  imports: [
    FormsModule,
    MatButtonModule,
...
export class BookingPdfComponent extends UnsubscribeOnDestroyAdapter implements OnInit {
  ...
  repData:StoringOrderTankItem[]=[];
  constructor(
    public dialogRef: MatDialogRef<BookingPdfComponent>,
  ...
  @ViewChild('pdfTable') pdfTable!: ElementRef; // Reference to the HTML content
   async exportToPDF_r1(fileName: string = 'document.pdf') {
     ...
     const comStyles: any = {
       ...
       1: { cellWidth: 28 ,valign: 'middle', halign: 'center'},   // "TANK_NO"
       2: {  cellWidth: 30 ,valign: 'middle', halign: 'center' },  // "CUSTOMER"
       3: { cellWidth: 30, valign: 'middle', halign: 'center' },  // "EIR_NO"
       4: { cellWidth: 25, valign: 'middle', halign: 'center' },   // "EIR_DATE "
       5: { cellWidth: 18,valign: 'middle', halign: 'center' },    // "STATUS."
       6: { cellWidth: 20 ,valign: 'middle', halign: 'center'},   // "YARD"
       7: {  cellWidth: 25,valign: 'middle', halign: 'center' },  // "BOOKING_DATE"
       8: { cellWidth: 30, valign: 'middle', halign: 'center' },  // "BOOKING_TYPE"
       9: { cellWidth: 30, valign: 'middle', halign: 'center' },   // "REFERENCE "
       10: { cellWidth: 30, valign: 'middle', halign: 'center' },   // "SURVEYOR "
     };
  ...
  GetReportTitle(): string {
    var title: string = '';
     title = `${this.translatedLangText.BOOKING}`;
    return `${title}`
  }
