...
@Component({
  selector: 'app-customer-wise-inventory-summary-pdf',
  templateUrl: './customer-wise-inventory-summary-pdf.component.html',
  styleUrls: ['./customer-wise-inventory-summary-pdf.component.scss'],
  standalone: true,
  imports: [
    FormsModule,
    MatButtonModule,
...
export class CustomerWiseInventorySummaryPdfComponent extends UnsubscribeOnDestroyAdapter implements OnInit {
