...
@Component({
  selector: 'app-unclean-tank-detail-pdf',
  templateUrl: './unclean-tank-pdf.component.html',
  styleUrls: ['./unclean-tank-pdf.component.scss'],
  standalone: true,
  imports: [
    FormsModule,
    MatButtonModule,
...
export class UncleanTankDetailInventoryPdfComponent extends UnsubscribeOnDestroyAdapter implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<UncleanTankDetailInventoryPdfComponent>,
