...
@Component({
  selector: 'app-customer-sales-report-details-pdf',
  templateUrl: './customer-sales-details-pdf.component.html',
  styleUrls: ['./customer-sales-details-pdf.component.scss'],
  standalone: true,
  imports: [
    FormsModule,
    MatButtonModule,
...
export class CustomerMonthlySalesReportDetailsPdfComponent extends UnsubscribeOnDestroyAdapter implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<CustomerMonthlySalesReportDetailsPdfComponent>,
