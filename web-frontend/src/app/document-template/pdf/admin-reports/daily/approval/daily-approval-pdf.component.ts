...
@Component({
  ...
  templateUrl: './daily-approval-pdf.component.html',
  styleUrls: ['./daily-approval-pdf.component.scss'],
  standalone: true,
  imports: [
    FormsModule,
    MatButtonModule,
...
export class DailyApprovalPdfComponent extends UnsubscribeOnDestroyAdapter implements OnInit {
