...
@Component({
  selector: 'app-daily-revenue-pdf',
  templateUrl: './daily-revenue-pdf.component.html',
  styleUrls: ['./daily-revenue-pdf.component.scss'],
  standalone: true,
  imports: [
    FormsModule,
    MatButtonModule,
...
export class DailyRevenuePdfComponent extends UnsubscribeOnDestroyAdapter implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<DailyRevenuePdfComponent>,
