...
import { report_status_yard, report_status, AdminReportMonthlyReport, DailyTeamRevenue, CleanerPerformance, SurveyorPerformanceSummary } from 'app/data-sources/reports';
...
@Component({
  ...
  templateUrl: './surveyor-summary-pdf.component.html',
  styleUrls: ['./surveyor-summary-pdf.component.scss'],
  standalone: true,
  imports: [
    FormsModule,
    MatButtonModule,
...
export class SurveyorPerformanceSummaryPdfComponent extends UnsubscribeOnDestroyAdapter implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<SurveyorPerformanceSummaryPdfComponent>,
