...
@Component({
  selector: 'app-cleaning-category-report-excel',
  templateUrl: './cleaning-category-excel.component.html',
  styleUrls: ['./cleaning-category-excel.component.scss'],
  standalone: true,
  imports: [
    FormsModule,
    MatButtonModule,
...
export class CleaningCategoryExcelComponent extends UnsubscribeOnDestroyAdapter implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<CleaningCategoryExcelComponent>,
  ...
  async exportExcel(items: CleaningCategoryItem[]) {
    const doc = new jsPDF();
