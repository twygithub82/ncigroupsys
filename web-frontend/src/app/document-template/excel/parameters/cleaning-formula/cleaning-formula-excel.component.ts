...
import { CleaningFormulaItem } from 'app/data-sources/cleaning-formulas';

// import { fileSave } from 'browser-fs-access';

export interface DialogData {
  repData: CleaningFormulaItem[],
  date: string
}
...
@Component({
  selector: 'app-cleaning-formula-report-excel',
  templateUrl: './cleaning-formula-excel.component.html',
  styleUrls: ['./cleaning-formula-excel.component.scss'],
  standalone: true,
  imports: [
    FormsModule,
    MatButtonModule,
...
export class CleaningFormulaExcelComponent extends UnsubscribeOnDestroyAdapter implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<CleaningFormulaExcelComponent>,
  ...
  async exportExcel(items: CleaningFormulaItem[]) {
    const doc = new jsPDF();
    ...
    doc.text("Cleaning Formula", 105, 15, { align: "center" });
