...
@Component({
  selector: 'app-cleaning-methods-report-excel',
  templateUrl: './cleaning-methods-excel.component.html',
  styleUrls: ['./cleaning-methods-excel.component.scss'],
  standalone: true,
  imports: [
    FormsModule,
    MatButtonModule,
...
export class CleaningMethodsExcelComponent extends UnsubscribeOnDestroyAdapter implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<CleaningMethodsExcelComponent>,
  ...
  async exportExcel(items: CleaningMethodItem[]) {
    const doc = new jsPDF();
    ...
    doc.text("Cleaning Methods", 105, 15, { align: "center" });
