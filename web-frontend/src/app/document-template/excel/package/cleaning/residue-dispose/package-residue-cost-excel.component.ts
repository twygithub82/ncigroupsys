...
@Component({
  selector: 'app-package-residue-cost-report-excel',
  templateUrl: './package-residue-cost-excel.component.html',
  styleUrls: ['./package-residue-cost-excel.component.scss'],
  standalone: true,
  imports: [
    FormsModule,
    MatButtonModule,
...
export class PackageResidueCostExcelComponent extends UnsubscribeOnDestroyAdapter implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<PackageResidueCostExcelComponent>,
  ...
  async exportExcel(items: PackageResidueItem[]) {
    const doc = new jsPDF();
