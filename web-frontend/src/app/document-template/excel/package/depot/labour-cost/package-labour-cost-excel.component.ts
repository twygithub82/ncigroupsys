...
@Component({
  selector: 'app-package-labour-cost-report-excel',
  templateUrl: './package-labour-cost-excel.component.html',
  styleUrls: ['./package-labour-cost-excel.component.scss'],
  standalone: true,
  imports: [
    FormsModule,
    MatButtonModule,
...
export class PackageLabourCostExcelComponent extends UnsubscribeOnDestroyAdapter implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<PackageLabourCostExcelComponent>,
  ...
  async exportExcel(items: PackageLabourItem[]) {
    const doc = new jsPDF();
