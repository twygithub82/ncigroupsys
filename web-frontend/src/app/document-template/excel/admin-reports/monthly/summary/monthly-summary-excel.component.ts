...
@Component({
  selector: 'app-monthly-summary-report-excel',
  templateUrl: './monthly-summary-excel.component.html',
  styleUrls: ['./monthly-summary-excel.component.scss'],
  standalone: true,
  imports: [
    FormsModule,
    MatButtonModule,
...
export class MonthlySummaryExcelComponent extends UnsubscribeOnDestroyAdapter implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<MonthlySummaryExcelComponent>,
...
async exportExcel(items: any) {
    ...
    var data: any[][] = resultsperDay.map((item,index) => {
                const row = [
