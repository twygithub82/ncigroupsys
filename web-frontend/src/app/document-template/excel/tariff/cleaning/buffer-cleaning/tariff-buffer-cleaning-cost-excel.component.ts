...
@Component({
  selector: 'app-tariff-buffer-cleaning-cost-report-excel',
  templateUrl: './tariff-buffer-cleaning-cost-excel.component.html',
  styleUrls: ['./tariff-buffer-cleaning-cost-excel.component.scss'],
  standalone: true,
  imports: [
    FormsModule,
    MatButtonModule,
...
export class TariffBufferCleaningCostExcelComponent extends UnsubscribeOnDestroyAdapter implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<TariffBufferCleaningCostExcelComponent>,
