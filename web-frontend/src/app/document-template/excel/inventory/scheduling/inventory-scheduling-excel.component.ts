...
@Component({
  selector: 'app-inventory-scheduling-report-excel',
  templateUrl: './inventory-scheduling-excel.component.html',
  styleUrls: ['./inventory-scheduling-excel.component.scss'],
  standalone: true,
  imports: [
    FormsModule,
    MatButtonModule,
...
export class InventorySchedulingExcelComponent extends UnsubscribeOnDestroyAdapter implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<InventorySchedulingExcelComponent>,
  ...
  async exportExcel(items: StoringOrderTankItem[]) {
    ...
    doc.text("Inventory Scheduling", 105, 15, { align: "center" });
