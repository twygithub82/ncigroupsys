...
@Component({
  selector: 'app-survey-period-report-excel',
  templateUrl: './survey-period-excel.component.html',
  styleUrls: ['./survey-period-excel.component.scss'],
  standalone: true,
  imports: [
    FormsModule,
    MatButtonModule,
...
export class SurveyPeriodExcelComponent extends UnsubscribeOnDestroyAdapter implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<SurveyPeriodExcelComponent>,
  ...
  return rows;
    ...
    const reportTitle: (string | number)[][] = [
      [`${this.translatedLangText.PERIOD_TEST_SURVEY}`]
    ];
