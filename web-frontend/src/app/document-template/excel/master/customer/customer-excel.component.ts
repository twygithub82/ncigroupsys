...
@Component({
  selector: 'app-customer-excel-report-excel',
  templateUrl: './customer-excel.component.html',
  styleUrls: ['./customer-excel.component.scss'],
  standalone: true,
  imports: [
    FormsModule,
    MatButtonModule,
...
export class CustomerExcelComponent extends UnsubscribeOnDestroyAdapter implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<CustomerExcelComponent>,
  ...
  async exportExcel(items: any[]) {
    ...
    doc.text("Customer Companies", 105, 15, { align: "center" });
