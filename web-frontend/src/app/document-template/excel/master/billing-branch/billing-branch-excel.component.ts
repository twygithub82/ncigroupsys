...
@Component({
  selector: 'app-billing-branch-excel-report',
  templateUrl: './billing-branch-excel.component.html',
  styleUrls: ['./billing-branch-excel.component.scss'],
  standalone: true,
  imports: [
    FormsModule,
    MatButtonModule,
...
export class BilingBranchExcelComponent extends UnsubscribeOnDestroyAdapter implements OnInit {
  ...
  langText = {
   NEW: 'COMMON-FORM.NEW',
    ...
    ADDRESS_1: 'COMMON-FORM.ADDRESS-1',
  ...
  constructor(
    public dialogRef: MatDialogRef<BilingBranchExcelComponent>,
  ...
  async exportExcel(items: CustomerCompanyItem[]) {
    ...
    doc.text("Billing Branch", 105, 15, { align: "center" });
