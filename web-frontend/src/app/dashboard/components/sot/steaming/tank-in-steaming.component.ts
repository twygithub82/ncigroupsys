...
@Component({
    selector: 'dashboard-tank-in-steaming',
    templateUrl: './tank-in-steaming.component.html',
    styleUrls: ['./tank-in-steaming.component.scss'],
    standalone: true,
    imports: [
      CommonModule,
...
export class TankInSteamingComponent {
  ...
  private loadData() {
    this.sot_waiting ="-";
    this.sotDS.getTotalTankInSteamingCount().subscribe(data => {
