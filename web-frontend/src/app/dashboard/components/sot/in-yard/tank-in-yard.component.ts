...
@Component({
    selector: 'dashboard-tank-in-yard',
    templateUrl: './tank-in-yard.component.html',
    styleUrls: ['./tank-in-yard.component.scss'],
    standalone: true,
    imports: [
      CommonModule,
      BreadcrumbComponent,
...
export class TankInYardComponent {
  ...
  private loadData() {
    this.sot_waiting ="-";
    this.sotDS.getTotalTankInYardCount().subscribe(data => {
