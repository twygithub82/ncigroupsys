...
INSERT INTO `idms`.`code_values` (`guid`, `description`, `code_val_type`, `code_val`) VALUES ('613', 'Residue Disposal Cost', 'SALES_COST_TYPE', 'RESIDUE');
...
ALTER TABLE `idms`.`storing_order_tank` 
CHANGE COLUMN `job_no_remarks` `job_no_remarks` VARCHAR(250) NULL DEFAULT NULL COMMENT 'For overwrite job no' AFTER `last_release_dt`,
CHANGE COLUMN `last_cargo_remarks` `last_cargo_remarks` VARCHAR(250) NULL DEFAULT NULL COMMENT 'For overwrite last cargo' AFTER `job_no_remarks`;
