...
CREATE TABLE `cleaning_group` (
  ...
  `category_cv` varchar(15) DEFAULT NULL,
...
INSERT INTO `code_values` VALUES ('1','Yes','YES_NO','Y',NULL,NULL,NULL,NULL,NULL,NULL),('10','Easy','CLEANING_CATEGORY','EASY',NULL,NULL,NULL,NULL,NULL,NULL),('11','Standard','CLEANING_CATEGORY','STANDARD',NULL,NULL,NULL,NULL,NULL,NULL),('12','Difficult','CLEANING_CATEGORY','DIFFICULT',NULL,NULL,NULL,NULL,NULL,NULL),('13','Special','CLEANING_CATEGORY','SPECIAL',NULL,NULL,NULL,NULL,NULL,NULL),('14','Owner','CUSTOMER_TYPE','OWNER',NULL,NULL,NULL,NULL,NULL,NULL),('15','Lessor','CUSTOMER_TYPE','LESSOR',NULL,NULL,NULL,NULL,NULL,NULL),('16','Sgd','CURRENCY','SGD',NULL,NULL,NULL,NULL,NULL,NULL),('17','Usd','CURRENCY','USD',NULL,NULL,NULL,NULL,NULL,NULL),('18','Repair','REPAIR_OPTION','REPAIR',NULL,NULL,NULL,NULL,NULL,NULL),('19','No Repair','REPAIR_OPTION','NO_REPAIR',NULL,NULL,NULL,NULL,NULL,NULL),('2','No','YES_NO','N',NULL,NULL,NULL,NULL,NULL,NULL),('20','Offhire','REPAIR_OPTION','OFFHIRE',NULL,NULL,NULL,NULL,NULL,NULL),('21','Yard 1','YARD','YARD_1',NULL,NULL,NULL,NULL,NULL,NULL),('22','Yard 2','YARD','YARD_2',NULL,NULL,NULL,NULL,NULL,NULL),('23','Both','LOLO','BOTH',NULL,NULL,NULL,NULL,NULL,NULL),('24','Lift-On','LOLO','LIFT_ON',NULL,NULL,NULL,NULL,NULL,NULL),('25','Lift-Off','LOLO','LIFT_OFF',NULL,NULL,NULL,NULL,NULL,NULL),('26','Mr.','PERSON_TITLE','MR.',NULL,NULL,NULL,NULL,NULL,NULL),('27','Mrs.','PERSON_TITLE','MRS.',NULL,NULL,NULL,NULL,NULL,NULL),('28','Waiting','SO_TANK_STATUS','WAITING',NULL,NULL,NULL,NULL,NULL,NULL),('29','Accepted','SO_TANK_STATUS','ACCEPTED',NULL,NULL,NULL,NULL,NULL,NULL),('3','Unknown','CLEAN_STATUS','UNKNOWN',NULL,NULL,NULL,NULL,NULL,NULL),('30','Cancelled','SO_TANK_STATUS','CANCELLED',NULL,NULL,NULL,NULL,NULL,NULL),('31','Cleaning','TANK_STATUS','CLEANING',NULL,NULL,NULL,NULL,NULL,NULL),('32','Repair','TANK_STATUS','REPAIR',NULL,NULL,NULL,NULL,NULL,NULL),('33','Steam','TANK_STATUS','STEAM',NULL,NULL,NULL,NULL,NULL,NULL),('34','Storage','TANK_STATUS','STORAGE',NULL,NULL,NULL,NULL,NULL,NULL),('35','Survey','TANK_STATUS','SURVEY',NULL,NULL,NULL,NULL,NULL,NULL),('36','Ingate','TANK_STATUS','INGATE',NULL,NULL,NULL,NULL,NULL,NULL),('37','Outgate','TANK_STATUS','OUTGATE',NULL,NULL,NULL,NULL,NULL,NULL),('38','Residue Disposal','TANK_STATUS','RESIDUE',NULL,NULL,NULL,NULL,NULL,NULL),('39','JJAP','MANUFACTURER','JJAP',NULL,NULL,NULL,NULL,NULL,NULL),('4','Clean','CLEAN_STATUS','CLEAN',NULL,NULL,NULL,NULL,NULL,NULL),('40','CIMC','MANUFACTURER','CIMC',NULL,NULL,NULL,NULL,NULL,NULL),('41','SINGAMAS','MANUFACTURER','SINGAMAS',NULL,NULL,NULL,NULL,NULL,NULL),('42','WELFIT','MANUFACTURER','WELFIT',NULL,NULL,NULL,NULL,NULL,NULL),('43','CXIC','MANUFACTURER','CXIC',NULL,NULL,NULL,NULL,NULL,NULL),('44','Gpr','CLADDING','GPR',NULL,NULL,NULL,NULL,NULL,NULL),('45','Aluminium White','CLADDING','ALUMINIUM_WHITE',NULL,NULL,NULL,NULL,NULL,NULL),('46','Stainless Steel','CLADDING','STAINLESS_STEEL',NULL,NULL,NULL,NULL,NULL,NULL),('47','Parallel','WALKWAY','PARALLEL',NULL,NULL,NULL,NULL,NULL,NULL),('48','L Walkway','WALKWAY','L_WALKWAY',NULL,NULL,NULL,NULL,NULL,NULL),('49','U Walkway','WALKWAY','U_WALKWAY',NULL,NULL,NULL,NULL,NULL,NULL),('5','Dirty','CLEAN_STATUS','DIRTY',NULL,NULL,NULL,NULL,NULL,NULL),('50','H Walkway','WALKWAY','H_WALKWAY',NULL,NULL,NULL,NULL,NULL,NULL),('51','8 Walkway','WALKWAY','8_WALKWAY',NULL,NULL,NULL,NULL,NULL,NULL),('52','T Walkway','WALKWAY','T_WALKWAY',NULL,NULL,NULL,NULL,NULL,NULL),('53','C Walkway','WALKWAY','C_WALKWAY',NULL,NULL,NULL,NULL,NULL,NULL),('54','Full Walkway','WALKWAY','FULL_WALKWAY',NULL,NULL,NULL,NULL,NULL,NULL),('55','Max Gross Weight','MAX_WEIGHT','20000',NULL,NULL,NULL,NULL,NULL,NULL),('56','Max Gross Weight','MAX_WEIGHT','26000',NULL,NULL,NULL,NULL,NULL,NULL),('57','Max Gross Weight','MAX_WEIGHT','30000',NULL,NULL,NULL,NULL,NULL,NULL),('58','Max Gross Weight','MAX_WEIGHT','34000',NULL,NULL,NULL,NULL,NULL,NULL),('59','Max Gross Weight','MAX_WEIGHT','36000',NULL,NULL,NULL,NULL,NULL,NULL),('6','Pending','SO_STATUS','PENDING',NULL,NULL,NULL,NULL,NULL,NULL),('60','8.5 Feet Height','TANK_HEIGHT','8.5',NULL,NULL,NULL,NULL,NULL,NULL),('61','9.5 Feet Height','TANK_HEIGHT','9.5',NULL,NULL,NULL,NULL,NULL,NULL),('62','Fortvale Butterfly Valve','DISCHARGE_TYPE','BUTTERFLY_VALVE',NULL,NULL,NULL,NULL,NULL,NULL),('63','Fortvale Ball Valve','DISCHARGE_TYPE','BALL_VALVE',NULL,NULL,NULL,NULL,NULL,NULL),('64','No Baffle','COMPARTMENT_TYPE','NO_BAFFLE',NULL,NULL,NULL,NULL,NULL,NULL),('65','Baffle','COMPARTMENT_TYPE','BAFFLE',NULL,NULL,NULL,NULL,NULL,NULL),('66','Multicompartment','COMPARTMENT_TYPE','MULTICOMPARTMENT',NULL,NULL,NULL,NULL,NULL,NULL),('7','Complete','SO_STATUS','COMPLETE',NULL,NULL,NULL,NULL,NULL,NULL),('8','Canceled','SO_STATUS','CANCELED',NULL,NULL,NULL,NULL,NULL,NULL),('9','Dirty','SO_STATUS','PROSESSING',NULL,NULL,NULL,NULL,NULL,NULL);
...
CREATE TABLE `customer_company` (
  ...
  `type_cv` varchar(15) DEFAULT NULL,
  ...
  `currency_cv` varchar(15) DEFAULT NULL,
...
CREATE TABLE `in_gate` (
  ...
  `eir_date` bigint DEFAULT NULL,
  `vehicle_no` varchar(20) DEFAULT NULL,
  `driver_name` varchar(120) DEFAULT NULL,
  `so_tank_guid` varchar(36) DEFAULT NULL,
  `yard_cv` varchar(36) DEFAULT NULL,
  `lolo_cv` varchar(15) DEFAULT NULL,
  `preinspection_cv` varchar(15) DEFAULT NULL,
  `delete_dt` bigint DEFAULT NULL,
  `create_dt` bigint DEFAULT NULL,
  `update_dt` bigint DEFAULT NULL,
  `create_by` varchar(45) DEFAULT NULL,
...
CREATE TABLE `in_gate_survey` (
  ...
  `periodic_test_guid` varchar(36) DEFAULT NULL,
  `manufacturer_cv` varchar(15) DEFAULT NULL,
  `dom_dt` bigint DEFAULT NULL,
  `cladding_cv` varchar(15) DEFAULT NULL,
  `capacity` int DEFAULT NULL,
  `tare_weight` int DEFAULT NULL,
  `max_weight_cv` varchar(15) DEFAULT NULL,
  `height_cv` varchar(15) DEFAULT NULL,
  `walkway_cv` varchar(15) DEFAULT NULL,
  `discharge_type_cv` varchar(15) DEFAULT NULL,
  `compartment_type_cv` varchar(15) DEFAULT NULL,
  `delete_dt` bigint DEFAULT NULL,
  `create_dt` bigint DEFAULT NULL,
  `update_dt` bigint DEFAULT NULL,
  `create_by` varchar(45) DEFAULT NULL,
...
CREATE TABLE `storing_order_tank` (
  ...
  `last_test_guid` varchar(36) DEFAULT NULL,
  ...
  `purpose_repair_cv` varchar(15) DEFAULT NULL,
  `required_temp` float DEFAULT NULL,
  `clean_status_cv` varchar(15) DEFAULT NULL,
  `certificate_cv` varchar(15) DEFAULT NULL,
  `remarks` varchar(255) DEFAULT NULL,
  `etr_dt` bigint DEFAULT NULL,
  `st` tinyint NOT NULL DEFAULT '0',
  `o2_level` tinyint NOT NULL DEFAULT '0',
  `open_on_gate_cv` varchar(15) NOT NULL DEFAULT '0',
  `status_cv` varchar(15) DEFAULT NULL,
  `tank_status_cv` varchar(15) DEFAULT NULL,
  `estimate_cv` varchar(15) DEFAULT NULL,
  `delete_dt` bigint DEFAULT NULL,
  `create_dt` bigint DEFAULT NULL,
  `create_by` varchar(45) DEFAULT NULL,
  `update_dt` bigint DEFAULT NULL,
...
INSERT INTO `storing_order_tank` VALUES ('09ab0e502e5911ef91a300ff079339a5','14d366b72e5611ef91a300ff079339a5','706915bd2e5411ef91a300ff079339a5','32345678901234567890123456789012',NULL,'EXFU1234567','1234567890',1719280800,1,0,1,'REPAIR',25.5,'CLEAN','Yes','Needs inspection',1719471600,1,0,'NO',NULL,NULL,NULL,NULL,1718814542,'admin',1718814542,'admin'),('09ab13942e5911ef91a300ff079339a5','14d366b72e5611ef91a300ff079339a5','706925452e5411ef91a300ff079339a5','42345678901234567890123456789012',NULL,'EHRN2345678','2345678901',1719360000,1,1,0,NULL,30,'DIRTY',NULL,'Routine check',1719547200,0,1,'YES',NULL,NULL,NULL,NULL,1718814542,'admin',1718814542,'admin'),('09ab148b2e5911ef91a300ff079339a5','14d366b72e5611ef91a300ff079339a5','706915bd2e5411ef91a300ff079339a5','52345678901234567890123456789012',NULL,'TRYI3456789','3456789012',1719460800,0,0,1,'REPAIR',28,'CLEAN','YES',NULL,NULL,1,0,'NO',NULL,NULL,NULL,NULL,1718814542,'admin',1718814542,'admin'),('09ab14f82e5911ef91a300ff079339a5','14d36c992e5611ef91a300ff079339a5','706925fe2e5411ef91a300ff079339a5','62345678901234567890123456789012',NULL,'EHYK4567890','4567890123',1719536400,1,0,0,'NO_REPAIR',27,'DIRTY','NO','Inspect after usage',NULL,0,1,'NO',NULL,NULL,NULL,NULL,1718814542,'admin',1718814542,'admin'),('09ab154e2e5911ef91a300ff079339a5','14d36c992e5611ef91a300ff079339a5','70691d1f2e5411ef91a300ff079339a5','72345678901234567890123456789012',NULL,'TYUI5678901','5678901234',1719640800,1,1,1,'REPAIR',26,'CLEAN','YES','Maintenance required',1719799200,1,1,'NO',NULL,NULL,NULL,NULL,1718814542,'admin',1718814542,'admin'),('09ab15bb2e5911ef91a300ff079339a5','14d36d752e5611ef91a300ff079339a5','70691d1f2e5411ef91a300ff079339a5','82345678901234567890123456789012',NULL,'YUIO6789012','6789012345',1719716400,0,1,0,'NO_REPAIR',29.5,'DIRTY','NO','Routine check',NULL,0,1,'YES',NULL,NULL,NULL,NULL,1718814542,'admin',1718814542,'admin'),('09ab160b2e5911ef91a300ff079339a5','14d36d752e5611ef91a300ff079339a5','706926b22e5411ef91a300ff079339a5','92345678901234567890123456789012',NULL,'YUEK7890123','7890123456',1719810000,1,0,1,'REPAIR',27.5,'CLEAN','YES',NULL,NULL,1,0,'NO',NULL,NULL,NULL,NULL,1718814542,'admin',1718814542,'admin'),('09ab16632e5911ef91a300ff079339a5','14d36d752e5611ef91a300ff079339a5','706926b22e5411ef91a300ff079339a5','12345678901234567890123456789012',NULL,'SQWR8901234','8901234567',1719885600,0,0,0,'NO_REPAIR',25,'DIRTY','NO','Needs maintenance',1720054800,0,1,'NO',NULL,NULL,NULL,NULL,1718814542,'admin',1718814542,'admin'),('09ab16b12e5911ef91a300ff079339a5','14d36d752e5611ef91a300ff079339a5','706928282e5411ef91a300ff079339a5','22345678901234567890123456789012',NULL,'VRYF9012345','9012345678',1719993600,1,1,1,'REPAIR',28.5,'CLEAN','YES','Urgent inspection',NULL,1,1,'YES',NULL,NULL,NULL,NULL,1718814542,'admin',1718814542,'admin'),('09ab17152e5911ef91a300ff079339a5','14d36dda2e5611ef91a300ff079339a5','706928282e5411ef91a300ff079339a5','32345678901234567890123456789012',NULL,'ZEET0123456','0123456789',1720072800,1,0,0,'NO_REPAIR',26.5,'UNKNOWN','NO','Routine check',NULL,0,1,'NO',NULL,NULL,NULL,NULL,1718814542,'admin',1718814542,'admin'),('09ab175e2e5911ef91a300ff079339a5','14d36dda2e5611ef91a300ff079339a5','7069276e2e5411ef91a300ff079339a5','42345678901234567890123456789012',NULL,'PODW1234567','1234567890',1720152000,0,1,1,'REPAIR',27,'CLEAN','YES',NULL,NULL,1,0,'NO',NULL,NULL,NULL,NULL,1718814542,'admin',1718814542,'admin'),('09ab17ab2e5911ef91a300ff079339a5','14d36e3a2e5611ef91a300ff079339a5','7069276e2e5411ef91a300ff079339a5','52345678901234567890123456789012',NULL,'JMKF2345678','2345678901',1720234800,1,0,0,'NO_REPAIR',25,'Dirty','NO','Inspect after usage',1720404000,0,1,'YES',NULL,NULL,NULL,NULL,1718814542,'admin',1718814542,'admin'),('09ab18002e5911ef91a300ff079339a5','14d36e3a2e5611ef91a300ff079339a5','706926b22e5411ef91a300ff079339a5','62345678901234567890123456789012',NULL,'LTES3456789','3456789012',1720332000,0,1,1,'REPAIR',28,'UNKNOWN','YES','Maintenance required',NULL,1,1,'NO',NULL,NULL,NULL,NULL,1718814542,'admin',1718814542,'admin'),('09ab184a2e5911ef91a300ff079339a5','14d36e3a2e5611ef91a300ff079339a5','70692a652e5411ef91a300ff079339a5','72345678901234567890123456789012',NULL,'QWER4567890','4567890123',1720404000,1,0,1,'REPAIR',26.5,'CLEAN','YES','Needs inspection',NULL,1,0,'YES',NULL,NULL,NULL,NULL,1718814542,'admin',1718814542,'admin'),('09ab18b22e5911ef91a300ff079339a5','14d36e3a2e5611ef91a300ff079339a5','706926b22e5411ef91a300ff079339a5','82345678901234567890123456789012',NULL,'AERY5678901','5678901234',1720501200,0,0,0,'NO_REPAIR',27.5,'UNKNOWN','NO','Routine check',1720659600,0,1,'NO',NULL,NULL,NULL,NULL,1718814542,'admin',1718814542,'admin');
...
-- Dump completed on 2024-06-22 23:20:16
