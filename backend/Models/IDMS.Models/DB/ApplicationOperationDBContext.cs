...
{
    public class ApplicationOperationDBContext : DbContext
    {
        public ApplicationOperationDBContext(DbContextOptions<ApplicationOperationDBContext> options) : base(options)
        {
