...
namespace IDMS.LicenseAuthentication.DB
{
    public class ApplicationDbContext: DbContext
    {
        ...
        public DbSet<license_user> license_user { get; set; }
        public DbSet<license_sub> license_sub { get; set; }
        public DbSet<license> license { get; set; }
        public DbSet<license_clients> license_clients { get; set; }
        public DbSet<license_validity> license_validity { get; set; }
