...
using System.Text;
using IDMS.Models.Parameter.CleaningGroup.GqlTypes;
...
builder.Services.AddGraphQLServer()
                .AddAuthorization()
               .AddQueryType<IDMS.Models.Parameter.CleaningGroup.GqlTypes.CleaningGroup_QueryType>()
               .AddMutationType<IDMS.Models.Parameter.CleaningGroup.GqlTypes.CleanningGroup_MutationType>()
               .AddFiltering()
               .AddProjections()
               .AddSorting();
