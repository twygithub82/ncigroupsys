...
namespace IDMS.Models.Parameter.CleaningProcedure.GqlTypes
{
    ...
    {
        // [Authorize]
        public async Task<List<EntityClass_CleaningProcedure>> QueryAllCleaningProcedures([Service] IConfiguration config, [Service] IHttpContextAccessor httpContextAccessor)
        {
