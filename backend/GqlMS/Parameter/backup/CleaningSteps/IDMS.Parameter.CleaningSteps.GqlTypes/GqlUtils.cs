...
namespace IDMS.Models.Parameter.CleaningSteps
{
    internal class GqlUtils
    {
        ...
        public static string GenerateSqlSelect(JToken jToken, string tableName)
        {
            ...
            string sqlSelect = $"SELECT {selectColumnsJoined} FROM {tableName} {whereClause};";
            return sqlSelect;
        }
        ...
        public static string FormatCondition(JProperty property)
        {
            ...
            {
                return $"{columnName} = '{EscapeSql(value.ToString())}'";
            }
