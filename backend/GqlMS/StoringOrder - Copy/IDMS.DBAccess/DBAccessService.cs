...
namespace IDMS.DBAccess
{
    public class DBAccessService : IDBAccess
    {
        ...
        public async Task<int> UpdateDataAsync<T>(StoringOder so, List<StoringOrderTank> soTanks)
        {
        ...
        public Task<int> InsertDataAsync(StoringOder so, List<StoringOrderTank> soTanks)
        {
            throw new NotImplementedException();
        }

        public Task<int> UpdateDataAsync(StoringOder so, List<StoringOrderTank> soTanks)
        {
            throw new NotImplementedException();
        }
    }
