...
using IDMS.StoringOrder.GqlTypes.Queries;
...
namespace IDMS.StoringOrder.Application
{
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddDbContext<BookDbContext>(o => o.UseMySql(connectionString, ServerVersion.AutoDetect(connectionString)).LogTo(Console.WriteLine));
