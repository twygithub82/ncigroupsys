...
{
    public class SOSubscription
    {
        [Subscribe]
        public StoringOrderRequest SOCreated([EventMessage] StoringOrderRequest result)
        {
            return result;
        }

        [Subscribe]
        public StoringOrderRequest SOUpdated([EventMessage] StoringOrderRequest result)
        {
            return result;
        }
